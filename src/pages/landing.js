...
import { WASH_PRICES } from "../utils/constants";
...
const Landing = () => {
  ...
  return (
    <div className='app-landing' data-bs-spy='scroll'>
      <div className='app-landing section-one'>
        <div className='container'>
          ...
          <div className='row app-landing body'>
      ...
      <div className='app-landing section-two' data-bs-spy='scroll'>
        {/* <div className='container'> */}
            ...
            <div className='body'>
              <div className='item'>
                <p className='icon-wrapper'>
                  <img src={AffordableWallet} alt='affordable-benefit' />
                </p>
                <div className=''>
              ...
              <div className='item'>
                <p className='icon-wrapper'>
                  <img src={Hanger} alt='convenience-benefit' />
                </p>
                <div className=''>
              ...
              <div className='item'>
                <p className='icon-wrapper'>
                  <img src={CustomerCare} alt='speed-benefit' />
                </p>
                <div className=''>
      ...
      <div className='app-landing section-three' data-bs-spy='scroll'>
        <div className='container' id='faq-questions'>
          <div className='_faqs'>
            ...
            <div className='row'>
              ...
              <div className='col-md-6 col-sm-12'>
                <div className='accordion' id='accordionExample_one'>
                  <div className='accordion-item'>
                    <button
                      className='accordion-button collapsed'
                      type='button'
